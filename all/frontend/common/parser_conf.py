...
CONF_ALLOWED_TYPES = {
    ...
    # Modulus
    TT_MOD_TOKEN                    : {"type":EXPR_MOD,"target_expr":[]},

    # Shift
    TT_COMBINED_SHIFT_RIGHT_TOKEN   :  {"type":EXPR_SHIFT_LEFT,"target_expr":[0], 
                                                                "shift_expr":[2]},
    TT_COMBINED_SHIFT_RIGHT_TOKEN   :  {"type":EXPR_SHIFT_RIGHT,"target_expr":[0], 
                                                                "shift_expr":[2]},

    

    # Index access
    STMT_SQUARE_PAREN               : {"type":EXPR_INDEX_ACCESS,"target_expr":[0],
                                                                "index_expr":[1]}  # a[b]                                 
