...
EXPR_BIT_AND_ASSIGN     = "EXPR_BIT_AND_ASSIGN"   # a &= b
EXPR_BIT_OR_ASSIGN      = "EXPR_BIT_OR_ASSIGN"    # a |= b
EXPR_BIT_XOR_ASSIGN     = "EXPR_BIT_XOR_ASSIGN"   # a ^= b
EXPR_LOGIC_AND_ASSIGN   = "EXPR_LOGIC_AND_ASSIGN" # a &= b
EXPR_LOGIC_OR_ASSIGN    = "EXPR_LOGIC_OR_ASSIGN"  # a |= b
EXPR_LOGIC_XOR_ASSIGN   = "EXPR_LOGIC_XOR_ASSIGN" # a ^= b
